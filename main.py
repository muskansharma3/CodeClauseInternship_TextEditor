...
def new_file(event=None):
    ...
    window.title('DIGNOTE - Untitled.txt')
...
def open_file(event=None):
    ...
    if url != '':
        ...
        window.title('DIGNOTE - '+os.path.basename(url))
    else:
        pass
...
def save_file(event=None):
    if url == '':
        ...
        if save_url is not None:
            save_url.write(data)
            window.title('DIGNOTE - '+os.path.basename(save_url.name))
            save_url.close() 
    else:
        data = textarea.get(1.0,END)
        file = open(url, 'w')
...
window = Tk()
window.title("DIGNOTE - Text Editor")
window.geometry('1100x700+210+15')
window.resizable(False,False)
light_title_bar(window)
img = PhotoImage(file = 'C:\\Users\\91958\\Dignote - Text Editor\\images\\icon.png')
...
# File Menu Section
newFileImage = PhotoImage(file='C:\\Users\\91958\\Dignote - Text Editor\\images\\newFile.png')
openFileImage = PhotoImage(file='C:\\Users\\91958\\Dignote - Text Editor\\images\\openFile.png')
saveFileImage = PhotoImage(file='C:\\Users\\91958\\Dignote - Text Editor\\images\\saveFile.png')
saveAsFileImage = PhotoImage(file='C:\\Users\\91958\\Dignote - Text Editor\\images\\saveAsFile.png')
exitFileImage = PhotoImage(file='C:\\Users\\91958\\Dignote - Text Editor\\images\\exitFile.png')
...
# Edit Menu Section
cutImage = PhotoImage(file='C:\\Users\\91958\\Dignote - Text Editor\\images\\cut.png')
copyImage = PhotoImage(file='C:\\Users\\91958\\Dignote - Text Editor\\images\\copy.png')
pasteImage = PhotoImage(file='C:\\Users\\91958\\Dignote - Text Editor\\images\\paste.png')
clearImage = PhotoImage(file='C:\\Users\\91958\\Dignote - Text Editor\\images\\clear.png')
findImage = PhotoImage(file='C:\\Users\\91958\\Dignote - Text Editor\\images\\find.png')
selectAllImage = PhotoImage(file='C:\\Users\\91958\\Dignote - Text Editor\\images\\selectall.png')
...
editmenu.add_command(label='Select All', accelerator = "Ctrl+A", image=selectAllImage, compound=LEFT, command=lambda : textarea.event_generate('<Control a>'))
...
toolBarImage = PhotoImage(file='C:\\Users\\91958\\Dignote - Text Editor\\images\\toolbar.png')
statusBarImage = PhotoImage(file='C:\\Users\\91958\\Dignote - Text Editor\\images\\statusbar.png')
...
# Theme Menu Section
lightImage = PhotoImage(file = 'C:\\Users\\91958\\Dignote - Text Editor\\images\\light.png')
darkImage = PhotoImage(file = 'C:\\Users\\91958\\Dignote - Text Editor\\images\\dark.png')
